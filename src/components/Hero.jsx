...
const HeroSection = () => {
    return (
        <div className="flex flex-col items-center mt-6 lg:mt-20 max-w-4xl mx-auto">
            ...
            <div className='flex mt-4 sm:mt-10 justify-center'>
                <video autoPlay lopp muted className="rounded-lg w-1/2 border border-orange-700 shadow-orange-400 mx-2 my-4"> 
